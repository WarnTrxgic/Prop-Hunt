...
* Load up MW2 Multiplayer and press compile (or ctrl+i)
* Start a private match and set the gamemode to Search and Destroy

Brav's Tool
* Take the default_mp.xex, dll_load.dll, and init.gscbin for whichever version you'd like to play
* Place the files on the root of your MW2 gamepath (ie HDD:\Games\Modern Warfare 2\[Project Files Here]
